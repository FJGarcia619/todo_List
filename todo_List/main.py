...
remove_text = int(input('Input the number of the task you want removed'))
...
def task_completed():
    ...
    task_to_be_marked_complete = int(input('Please enter the number of the task you completed.'))
    ...
    task[task_to_be_marked_complete]['completed'] = True
menu_text = """
====================
1. List the tasks
2. Add a task
